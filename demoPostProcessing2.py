...
def demo():
    ...
    gsm_path = FileTool.get_project_dir(sub="data/L2_SH_products/GSM/CSR/RL06/BA01/CSR_RL06_GSM_BA01")
    ...
    filter_method, filter_params = Enums.SHCFilterType.DDK, (1,)
    ...
    basin_path_shp = FileTool.get_project_dir("data/basin_mask/Shp/GAB_shp")
